"""
Django settings for healthcircle project.
...
ALLOWED_HOSTS = ['health-circle-web.herokuapp.com', '127.0.0.1']
...
ROOT_URLCONF = 'healthcircle.urls'
...
WSGI_APPLICATION = 'healthcircle.wsgi.application'
